...
let outro = [
  "Thanks for choosing KAMRAN-XD!",
  "Powered by *𝙆𝘼𝙈𝙍𝘼𝙉 𝙓𝘿💻*",
...
⭐ *GitHub:* https://github.com/KAMRAN-XD/KAMRAN-XD.git`;

    conn.sendMessage(conn.user.id, { image: { url: `https://https://files.catbox.moe/u3e4gj.jpg` }, caption: up })
  }
  })
  ...
  const udp = botNumber.split('@')[0];
    const erfan = ('923196891871', '923196891871', '923196891871');
...
if (isBanned) return; // Ignore banned users completely
  ...
  const ownerFile = JSON.parse(fs.readFileSync('./lib/sudo.json', 'utf-8'));  // 𝒟𝑅 𝒦𝒜𝑀𝑅𝒜𝒩 
